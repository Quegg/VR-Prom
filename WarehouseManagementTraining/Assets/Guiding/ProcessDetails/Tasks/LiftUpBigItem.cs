...
{
    public class LiftUpBigItem : MonoBehaviour, ITaskDetails {
        private GuidingController myGuidingController;
        private string classNameRaw="LiftUpBigItem";
        [SerializeField] private OutlineController liftUpButtonOutlineController;
        ...
        public void ShowHelp()
        {
            mistakesHappened = 0;
            helpShown = true;
            liftUpButtonOutlineController.StartOutlineAnimation();
        ...
        private void HideHelp()
        {
            helpShown = false;
            mistakesHappened = 0;
            liftUpButtonOutlineController.HideOutline();
        ...
        public bool IsDone()
        {
            //the event gets logged, if the fork was lifted up with a pallet on it
            //TODO check, if it was the right pallet and adjust help
            return true;
        }
