...
{
    public class SetHandmodeToBarcodeScanner1 : MonoBehaviour, ITaskDetails {
        private GuidingController myGuidingController;
        private string classNameRaw="SetHandmodeToBarcodeScanner1";
        ...
        public void ShowHelp()
        {
            ...
            barcodeScannerController.ShowButtonHintsForBarcodeScanner();
