...
{
    public class ScanRobot : MonoBehaviour, ITaskDetails {
        private GuidingController myGuidingController;
        private string classNameRaw="ScanRobot";
        [SerializeField] private GameObject robotBarcode;

        private OutlineController robotBarcodeOutline;
        ...
        private void Start()
        {
            robotBarcodeOutline = robotBarcode.GetComponent<OutlineController>();
        }
        ...
        public void ShowHelp()
        {
            ...
            robotBarcodeOutline.StartOutlineAnimation();
        ...
        private void HideHelp()
        {
            ...
            helpShown = false;
            mistakesHappened = 0;
            robotBarcodeOutline.HideOutline();
