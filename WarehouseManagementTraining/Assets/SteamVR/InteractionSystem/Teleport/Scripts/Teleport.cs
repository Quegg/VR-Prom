...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Teleport : MonoBehaviour
    {
        ...
        private BoxCollider robotArea;
		
		


        [Header("Predefined Properties:")]
        ...
        void Start()
        {
            ...
            agent = roboter.GetComponent<NavMeshAgent>();
            robotArea = GetComponent<BoxCollider>();
        ...
        private void TeleportPlayer()
        {
            ...
            if (robotEnabled)
            {
                if (robotArea.bounds.Contains(teleportPosition))
                {
                    

                    if (agent.SetDestination(teleportPosition))
                    {
                        
                    }
                    else
                    {
                        Debug.Log("Robot destination set failed");
                    }
                }
            }
            //Invoke Eventsystem to log teleportation
            teleportEnd.Invoke();
            //-------------------------------------//
        }
